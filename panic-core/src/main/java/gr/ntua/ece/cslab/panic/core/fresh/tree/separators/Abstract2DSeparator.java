...
/**
 * Abstract class dictating the API of the Abstract2DSeparator classes and holding the implementation
 * of the common functionality.
 * Created by Giannis Giannakopoulos on 2/11/16.
 */
public abstract class Abstract2DSeparator implements Separator{
     ...
     */
    public Abstract2DSeparator(DecisionTreeLeafNode original) {
...
//        System.out.println("Abstract2DSeparator.separate: "+possibleValues);
...
//         setting result
        if (best != null) {
            ...
            if(leftListSize+rightListSize != best.getOriginal().size()) {
                System.err.println("Abstract2DSeparator.separate: xontri malakia edw mesa!");
                System.exit(1);
            }
...
//                System.err.println("Abstract2DSeparator.separate");
//                System.err.println("Solution WAS found but it produced poor-er results!");
    ...
    protected String[] findTwoBestDimensions(HashMap<String,Set<Double>> possibleValues) {
        ...
        // FIXME : this contains a bug, please refactor!!
...
//                    System.out.println("Abstract2DSeparator.findTwoBestDimensions: solution found, but it cannot be accepted");
                }
            }
        }
...
//        System.out.println("Abstract2DSeparator.createPointCouplesExhaustive"+couples.size());
        return couples;
    }
...
//            System.out.println("Abstract2DSeparator.createPointCouplesAxisParallel: "+dim);
