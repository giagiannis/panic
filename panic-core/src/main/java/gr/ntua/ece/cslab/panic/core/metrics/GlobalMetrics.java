...
public class GlobalMetrics {
    ...
    public GlobalMetrics(List<OutputSpacePoint> objective, Model m, List<InputSpacePoint> sampled) {
    ...
    public double getMSE(){
        ...
        for(OutputSpacePoint p : objective) {
            try {
                ...
                Logger.getLogger(GlobalMetrics.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
